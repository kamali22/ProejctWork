...
function Furniture({handleClick, handleClear}) {
            ...
            return(
              <div className='section'>
                {Object.values(item).map((items) => {
                  ...
                  if(items.category.toLowerCase() === 'furniture') {
                    return(
                        ...
                        <Container>
                            ...
                            <Button className='cart-button' onClick={() => handleClick(items)}>Add to cart</Button>
                            </Card.Body>
                        </Container>
                        </div> 
                    ); 
